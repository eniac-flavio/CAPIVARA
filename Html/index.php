<?php
    ...
    if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
        ...
        // Verifica se 'user_email' está definido na sessão
...
<body>
    ...
    <?php
        ...
        if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
            ...
            // Se há produtos no carrinho
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    // Adiciona dados do produto ao array
                    $produto = array(
                        'id' => $row['id_produtos'],
    ...
    <nav class="flexcenter">
        ...
        <a href="blusas.php" tabindex="5">Blusas</a>
        <a href="calcas.php" tabindex="6">Calças</a>
    </nav>

    <main class="aligncenter">
        <aside class="flexaround">
            <div class="container flexcenter aligncenter">
                ...
                <div class="content">
                    <h2>Pagamento</h2>
                    <p>Por dinheiro, cartão de crédito e PIX.</p>
                </div>
            </div>
            <div class="container flexcenter aligncenter">
                <div class="content">
                ...
                <div class="content">
                    <h2>Encomenda</h2>
                    <p>Por <a href="https://www.instagram.com/direct/t/17842009043278152/" target="_blank" tabindex="-1">direct</a> e <a href="https://api.whatsapp.com/send?phone=5511984577114&text=Quero+saber+sobre+a+linha+de+moletons+capivara%21%21" target="_blank" tabindex="-1">Whatsapp</a>.</p>
                </div>
            </div>
            <div class="container flexcenter aligncenter">
                <div class="content">
                ...
                <div class="content">
                    <h2>Entrega</h2>
                    <p>Com segurança para todo Brasil.</p>
                </div>
            </div>
        </aside>
    </main>
    ...
    <script>
        ...
        document.getElementById('formsearch').addEventListener('submit', function(event) {
            ...
            if (!q && !minPrice && !maxPrice) {
                event.preventDefault(); // Nada pode estar vazio
